...
--
-- Client :  localhost
-- Généré le :  Jeu 30 Avril 2020 à 15:32
...
(4081, 'zaerty', 'AFG', NULL, 12),
(4082, 'erfaez', 'AFG', NULL, 125);
...
('20200430085710', '2020-04-30 08:57:38');
...
(1, 'toto@nono.fr', '["ROLE_USER"]', '$argon2i$v=19$m=65536,t=4,p=1$OEpUbUVFeFlpUzY0L3dobw$ilVi7OA9FD3AIJj/EkJMMowC8qwh0Vl77VNSSBOpr/E'),
(2, 'popo@nono.fr', '["ROLE_ADMIN"]', '$argon2i$v=19$m=65536,t=4,p=1$UzhTejViYW9FYTlEenhiSg$WzcZccHiQASRM5gAdJqLGTfy60PfY8CdAsKwa2E10ng');
...
ALTER TABLE `countrylanguage`
  ADD PRIMARY KEY (`Language`,`CountryCode`),
  ADD KEY `CountryCode` (`CountryCode`);
